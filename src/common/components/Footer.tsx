...
const navigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/TEDxFPTUniversityHCMC',
            icon: (props: any) => (
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/explore/locations/108201587719514/tedx-fpt-university-hcmc/',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        <footer className={cn('bg-black/80', props.className)}>
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <p className="mt-10 text-center text-xs leading-5 text-gray-400">
                    &copy; 2020 Skillcetera, Inc. All rights reserved.
                </p>
            </div>
        </footer>
    );
